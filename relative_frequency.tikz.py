...
# Plot the first diagram: Relative Frequency (vertical) vs. Fehlerart (horizontal)
plt.figure(figsize=(10, 6))
colors = ['skyblue'] * len(df_sorted_by_frequency['Fehlerart'])
top_3_color = 'red'
colors[:3] = [top_3_color] * 3
plt.bar(df_sorted_by_frequency['Fehlerart'], df_sorted_by_frequency['Relative Häufigkeit'] * 100, color=colors)
plt.title('Relative Häufigkeit der Fehlerarten')
